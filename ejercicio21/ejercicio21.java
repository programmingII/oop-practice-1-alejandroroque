...
public class ejercicio21{
 ...
 // por otra parte , lo del parentesis la palabra in es indicar que va a recibir datos
  ...
  System.out.print("Ingrese el nummero decimal para convertirlo a numero octal: "); // se imprime en pantalla un frase indicando que ingrese el numero para convertirlo a Octal
  String a = scan.nextLine(); // lee el numero ingresado por el usuario a la variable a
  System.out.println("El numero Octal es: " + Integer.toOctalString((Integer.parseInt(a, 10)))); // esta linea lo que hace es que toma el valor ingresado de la variable a para que en si
   // el numero ingresado se transforme a Octal usando el Integer.toOctalString
 }
}
