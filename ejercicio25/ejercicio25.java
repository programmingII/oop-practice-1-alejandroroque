...
public class ejercicio25{
 ...
 // por otra parte , lo del parentesis la palabra in es indicar que va a recibir datos
  ...
  System.out.print("Ingrese el numero Octal para convertirlo a Decimal: "); // se imprime en pantalla un frase indicando que ingrese el numero para convertirlo a Decimal
  String a = scan.nextLine(); // lee el numero ingresado por el usuario a la variable a
  System.out.println("El numero Decimal es: " + ((Integer.parseInt(a, 8))));  // esta linea lo que hace es que toma el valor ingresado de la variable a para que en si
