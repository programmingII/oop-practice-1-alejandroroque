...
public class ejercicio29{
 ...
 System.out.println("Ingrese el numero Hexadecimal para convertirlo a Binario:"); // se imprime el mensaje preguntando que ingrese un numero para la conversion
 String a= scan.nextLine(); // se leera la variable a con el dato ingresado por el usuario
 System.out.println("El numero Binario es: " + Integer.toBinaryString((Integer.parseInt(a, 16)))); // aqui se imprime el resultado de la conversion dando un mensaje y con el codigo
