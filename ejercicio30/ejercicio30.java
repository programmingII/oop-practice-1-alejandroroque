...
public class ejercicio30{
 ...
 System.out.println("Ingrese el numero Hexadecimal para convertirlo a Octal"); // se imprime el mensaje preguntando que ingrese un numero para la conversion
 String a= scan.nextLine(); // se leera la variable a con el dato ingresado por el usuario
 System.out.println("El numero Octal es: " + Integer.toOctalString((Integer.parseInt(a, 16)))); // aqui se imprime el resultado de la conversion dando un mensaje y con el codigo
